...
# create the donor registration form
class DonorRegistration(tk.Frame):
    ...
    def __init__(self, master,user,pswd):
        ...
        self.canvas = tk.Canvas(self.frame, width=self.winfo_screenwidth(),height=self.winfo_screenheight())
        ...
        label_age.grid(column=0, row=6, padx=10, pady=5, sticky=tk.W)
        self.entry_age = ttk.Entry(self.frame)
        self.entry_age.grid(column=1, row=6, padx=10, pady=5, sticky=tk.W)

               
        label_gender = ttk.Label(self.frame, text="Gender:")
        label_gender.grid(column=0, row=7, padx=10, pady=5, sticky=tk.W)
        self.combobox_gender = ttk.Combobox(self.frame, values=["Male", "Female", "Other"])
        self.combobox_gender.grid(column=1, row=7, padx=10, pady=5, sticky=tk.W)

        label_weight = ttk.Label(self.frame, text="Weight (in kg):")
        label_weight.grid(column=0, row=8, padx=10, pady=5, sticky=tk.W)
        self.entry_weight = ttk.Entry(self.frame)
        self.entry_weight.grid(column=1, row=8, padx=10, pady=5, sticky=tk.W)
        ...
        label_hemoglobin = ttk.Label(self.frame, text="Hemoglobin:")
        label_hemoglobin.grid(column=0, row=16, padx=10, pady=5, sticky=tk.W)
        self.entry_hemoglobin = ttk.Entry(self.frame)
        self.entry_hemoglobin.grid(column=1, row=16, padx=10, pady=5, sticky=tk.W)
    
        label_blood_group = ttk.Label(self.frame, text="Blood Group:")
        label_blood_group.grid(column=0, row=17, padx=10, pady=5, sticky=tk.W)
        self.combobox_blood_group = ttk.Combobox(self.frame, values=["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"])
        self.combobox_blood_group.grid(column=1, row=17, padx=10, pady=5, sticky=tk.W)
    ...
    def submit(self):
        ...
        #last_donation_date = self.entry_last_donation_date.get()
        ...
        hemoglobin = self.entry_hemoglobin.get()
        blood_group = self.combobox_blood_group.get()
        lab_technician_id = random.randint(1, 10)
        ...
        try:
            ...
            mycursor.execute("select check_registration(%s)", (username,))
            ...
            sql = "INSERT INTO donor (donor_fname, donor_lname, donor_username, donor_password, donor_age, gender, donor_weight, street, city, state, zip_code, donor_phone, donor_email, donor_hemoglobin, donor_blood_group, lab_technician_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
       
            mycursor.execute(sql, (fname, lname, username, password, age, gender, weight, street, city, state, zip_code, phone, email, hemoglobin, blood_group, lab_technician_id))
            mydb.commit()
