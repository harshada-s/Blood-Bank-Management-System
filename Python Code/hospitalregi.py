...
# create the hospital registration form
class HospitalRegistration(tk.Frame):
    ...
    def __init__(self, master,user,pswd):
        ...
        self.user=user
        self.pswd=pswd
        self.master.title("Hospital Registration")
        ...
        label_hptname = ttk.Label(self.frame, text="First Name:")
        label_hptname.grid(column=0, row=1, padx=10, pady=5, sticky=tk.W)
        self.entry_hptname = ttk.Entry(self.frame)
        self.entry_hptname.grid(column=1, row=1, padx=10, pady=5, sticky=tk.W)


        label_hptusername = ttk.Label(self.frame, text="Username:")
        label_hptusername.grid(column=0, row=3, padx=10, pady=5, sticky=tk.W)
        self.entry_hptusername = ttk.Entry(self.frame)
        self.entry_hptusername.grid(column=1, row=3, padx=10, pady=5, sticky=tk.W)

        label_hptpassword = ttk.Label(self.frame, text="Password:")
        label_hptpassword.grid(column=0, row=4, padx=10, pady=5, sticky=tk.W)
        self.entry_hptpassword = ttk.Entry(self.frame, show="*")
        self.entry_hptpassword.grid(column=1, row=4, padx=10, pady=5, sticky=tk.W)


        label_hptconfirm_password = ttk.Label(self.frame, text="Confirm Password:")
        label_hptconfirm_password.grid(column=0, row=5, padx=10, pady=5, sticky=tk.W)
        self.entry_hptconfirm_password = ttk.Entry(self.frame, show="*")
        self.entry_hptconfirm_password.grid(column=1, row=5, padx=10, pady=5, sticky=tk.W)
    ...
    def submit(self):
        # get the form data
        hptname = self.entry_hptname.get()
        hptusername = self.entry_hptusername.get()
        hptpassword = self.entry_hptpassword.get()
        hptconfirm_password = self.entry_hptconfirm_password.get()
        ...
        if hptpassword != hptconfirm_password:
        ...
        try:
            ...
            mycursor.execute("select check_registration(%s)", (hptusername,))
            ...
            sql = "INSERT INTO hospital(hospital_name, hpt_username, hpt_password, street, city, state, zip_code, hpt_phone, hpt_email) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
       
            mycursor.execute(sql, (hptname, hptusername, hptpassword, street, city, state, zip_code, phone, email))
            mydb.commit()
